...
plot \
	...
	[0:0:1] "+" us (ClassA_shared_warp_inst_intensity):(ClassA_warp_shared_instruction_performance) with points lc rgb shared_color pt ClassA_point ps point_size title "Shared (ldst\\\_inst)",\
	[0:0:1] "+" us (ClassB_shared_warp_inst_intensity):(ClassB_warp_shared_instruction_performance) with points lc rgb shared_color pt ClassB_point ps point_size notitle,\
	[0:0:1] "+" us (ClassC_shared_warp_inst_intensity):(ClassC_warp_shared_instruction_performance) with points lc rgb shared_color pt ClassC_point ps point_size notitle
